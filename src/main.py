...
commit_string = "I started to work here on 26.10.2022. On that day I had to clean up the development mess and the " \
                ...
                "committed after that and then committed and the next day I committed. Today I committed and " \
                "committed again and committed after that and committed after that and then committed."
n_commits = 29
