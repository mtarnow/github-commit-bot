...
commit_string = "The first day I laid in bed and the next day and the next day I didn't commit and the next day I did" \
                "n't commit and the next day I committed and the next day I committed and committed again and then co" \
                "mmitted and committed again and the next day I committed and committed after that and committed afte" \
                "r that and then committed and the next day I committed and then committed and committed after that a" \
                "nd then committed. Today I committed and committed after that and committed after that and then comm" \
                "itted."
n_commits = 0
