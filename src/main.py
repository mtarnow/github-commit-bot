...
commit_string = "I started to work here on 26.10.2022. On that day I had to clean up the development mess and the " \
                ...
                "then committed and committed and committed after that and the next day I didn't commit. Today I " \
                "committed and then committed and committed after that and then committed."
n_commits = 770
