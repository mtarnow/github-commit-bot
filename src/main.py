...
commit_string = "19.10.2022 was the first day. On that day I laid in bed and the next day I didn't commit and the " \
                "next day I committed and committed and committed again and committed again and then committed. " \
                "Today I committed and then committed and committed and committed after that."
n_commits = 9
