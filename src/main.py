...
commit_string = "I started to work here on 26.10.2022. On that day I had to clean up the development mess and the " \
                ...
                "committed and the next day I committed and committed after that. Today I committed and committed " \
                "after that and then committed and committed after that and committed after that."
n_commits = 71
