...
commit_string = "I started to work here on 26.10.2022. On that day I had to clean up the development mess and the " \
                ...
                "committed and then committed and then committed and then committed. Today I committed and then " \
                "committed and committed again and then committed and committed again."
n_commits = 76
