...
commit_string = "I started to work here on 26.10.2022. On that day I had to clean up the development mess and the " \
                ...
                "committed and the next day I committed and committed again and the next day I committed and " \
                "committed after that and then committed and committed and then committed and the next day I " \
                "committed and committed again and committed again and committed and committed again and the next " \
                "day I committed and the next day I committed and the next day I committed and then committed and " \
                "the next day I committed and the next day I committed and committed after that and the next day I " \
                "committed and committed after that and then committed and committed again and the next day I " \
                "committed and committed and committed and the next day I committed and committed. Today I  and the " \
                "next day I didn't commit and the next day I didn't commit and the next day I didn't commit and the " \
                "next day I committed and committed after that and the next day I committed and the next day I " \
                "didn't commit and the next day I committed and the next day I committed and committed and committed " \
                "after that and the next day I didn't commit and the next day I committed and then committed and the " \
                "next day I committed and the next day I committed and committed and the next day I didn't commit " \
                "and the next day I committed and the next day I committed and then committed and the next day I " \
                "committed and the next day I committed and committed again and the next day I committed and then " \
                "committed and the next day I committed and committed again and the next day I committed and then " \
                "committed and committed and the next day I committed and committed after that and committed after " \
                "that and committed after that and then committed and the next day I didn't commit and the next day " \
                "I committed and committed again and committed and then committed and the next day I committed and " \
                "committed after that and the next day I committed and the next day I committed and committed again " \
                "and the next day I committed and committed and then committed and committed again and the next day " \
                "I committed and committed and committed again and then committed and committed and the next day I " \
                "committed and then committed and the next day I committed and committed after that and committed " \
                "and then committed and committed after that and the next day I committed and committed after that " \
                "and then committed and the next day I didn't commit and the next day I committed. Today I  and the " \
                "next day I committed and committed again and the next day I committed and the next day I didn't " \
                "commit and the next day I committed and committed again and then committed and then committed and " \
                "committed after that and the next day I didn't commit and the next day I committed and committed " \
                "and committed again and committed and the next day I didn't commit and the next day I committed and " \
                "then committed and committed and committed after that and the next day I didn't commit and the next " \
                "day I committed and committed again and committed and committed and the next day I committed and " \
                "committed after that and committed and the next day I committed and committed again and committed " \
                "again and the next day I committed and committed after that and committed and committed and " \
                "committed after that and the next day I committed and committed again and the next day I committed " \
                "and then committed and then committed and then committed and the next day I committed and committed " \
                "and the next day I didn't commit and the next day I didn't commit and the next day I didn't commit. " \
                "Today I committed and then committed and committed again and committed after that and committed " \
                "after that. and the next day I didn't commit and the next day I committed and committed again and " \
                "the next day I committed and the next day I committed and then committed and committed again and " \
                "committed and the next day I committed and committed and the next day I committed and committed " \
                "after that and then committed and committed and then committed and the next day I didn't commit and " \
                "the next day I didn't commit and the next day I committed and committed again and committed and " \
                "committed and the next day I committed and then committed and then committed and the next day I " \
                "committed and committed after that and committed again and the next day I didn't commit and the " \
                "next day I didn't commit and the next day I committed and committed again and the next day I didn't " \
                "commit and the next day I committed and committed after that and the next day I committed and " \
                "committed after that and the next day I committed and then committed and committed after that and " \
                "committed after that and committed again and the next day I committed and committed after that and " \
                "committed again and then committed and the next day I committed and committed after that and " \
                "committed and the next day I committed and committed and then committed and then committed and the " \
                "next day I committed and the next day I committed and then committed and committed after that and " \
                "the next day I didn't commit and the next day I committed and committed after that and committed " \
                "and the next day I committed and committed and committed again and the next day I didn't commit and " \
                "the next day I committed and the next day I committed and committed again and then committed and " \
                "committed after that and committed and the next day I committed and committed after that and " \
                "committed and committed again and the next day I committed and committed again and then committed " \
                "and committed again and committed and the next day I didn't commit. Today I committed and committed " \
                "again and committed after that and committed."
n_commits = 869
